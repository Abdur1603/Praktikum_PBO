...
public class MenuCustomer {
    ...
    static void buatPesanan() {
        ...
        Pesanan pesananBaru = new Pesanan(idCustomer, customerTerpilih.getNama(), idTabung, tabungTerpilih.getJenis(), jumlahPesan);
        daftarPesanan.add(pesananBaru);

        System.out.println("Pesanan berhasil! " + customerTerpilih.getNama() + " memesan " + jumlahPesan + " gas.");
    }
