...
public class MenuTabung {
    ...
    static void tambahTabung(ArrayList<Supplier> daftarSupplier) {
        ...
        for (Supplier s : daftarSupplier) {
            System.out.println(s.getId() + ". " + s.getNama());
        }
        ...
        daftarTabung.add(new TabungGas(id, jenis, kapasitas, jumlahIsi, idSupplier, supplierTerpilih.getNama()));
        System.out.println("Tabung gas berhasil ditambahkan dari supplier " + supplierTerpilih.getNama() + "!");
    }
    ...
    static void updateTabung() {
        ...
        for (TabungGas t : daftarTabung) {
            if (t.getId() == id) {
                ...
                t.setJenis(input.nextLine());
                System.out.print("Kapasitas baru (jumlah tabung): ");
                t.setKapasitas(input.nextInt());
                System.out.print("Jumlah Gas Isi: ");
                t.setJumlahIsi(input.nextInt());
    ...
    static void hapusTabung() {
        ...
        int id = input.nextInt();
        daftarTabung.removeIf(t -> t.getId() == id);
